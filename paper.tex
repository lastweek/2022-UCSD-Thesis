...
\usepackage{setspace}
\doublespace
\usepackage[font=small, width=0.9\textwidth,tableposition=top]{caption}
...
\bibliography{local,paper,hotpot/all,hotpot/local,hotpot/paper,clio/local,clio/paper,snic/local,snic/paper}
